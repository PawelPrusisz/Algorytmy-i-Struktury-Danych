...
public class zadanie4{
	...
	public static void Testing(int k) throws Exception
	{
		...
		for(int i = 10000; i <= 10000; i+=100)
		{
			...
			//String out1 = i + ";";
			//String out2 = i + ";";
			for(int small = 3; small < 100; small++)
			{
				String out1 = i + ";";
				String out2 = i + ";";
				...
				{
					ArrayList<Integer> ctrl = new ArrayList<Integer>();
					ArrayList<String> str = new ArrayList<String>();
					ctrl = RandomArrayGenerator(i, min, max);
					str = RandomStringGen(i, max/1000);
					String outt1 = QuickInsertionInit(ctrl, small, "<=");
					String outt2 = QuickInsertionInitStr(str, small, "<=");
					String[] ans1, ans2;
					ans1 = outt1.split(";");
					ans2 = outt2.split(";");
