    ...
    if(ver == 1)
    {
        for(int size = 100; size <= 10000; size+=100)
        {
            ...
            for(int i = 1; i <= m; i++)
            {
                ...
                double timeTake= diff.count()*1000000000.0;
                double compMake = comp1*1.0;
                double swapMake = swap1*1.0;

                
                cout<<(long long)compMake<<";"<<(long long)swapMake<<";"<<(long long)timeTake<<";;";
                /////RANDOM SELECT
                ...
                timeTake= diff.count()*1000000000.0;
                compMake = comp2*1.0;
                swapMake = swap2*1.0;
